...
export default function NicheDropdown({ selected, onChange }: NicheDropdownProps) {
  ...
  return (
    <div ref={ref} className="relative flex-shrink-0">
      <button
        onClick={() => setOpen(o => !o)}
        className={`flex items-center gap-1.5 px-4 py-2.5 rounded-xl text-sm font-medium transition-all border shadow-sm ${
          isActive
            ? 'bg-blue-600 text-white border-blue-600'
            : 'bg-white text-gray-600 border-gray-200 hover:border-gray-300 hover:text-gray-900 dark:bg-[#1a1a1a] dark:text-gray-400 dark:border-[#2a2a2a] dark:hover:border-[#3a3a3a]'
        }`}
      >
