...
export default function AdvancedFilters({ initial, onApply, onClose }: Props) {
  ...
  const activeCount = [
    ...
    f.subsMin > 0 || f.subsMax < 100_000_000,
    f.avgViewsMin > 0 || f.avgViewsMax < 100_000_000,
    f.totalViewsMin > 0 || f.totalViewsMax < 900_000_000_000,
    f.totalVideosMin > 0 || f.totalVideosMax < 100_000,
    f.outlierMin > 0 || f.outlierMax < 100,
    f.monthlyViewsMin > 0 || f.monthlyViewsMax < 900_000_000,
    f.avgVideoLengthMin > 0 || f.avgVideoLengthMax < 43200,
